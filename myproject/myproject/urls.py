...
urlpatterns = [
    ...
    url(r'^museos/?$', views.museos, name = 'Muestra la página con todos los museos'),
    url(r'^museos/(.*)/?$', views.pagmuseo, name = 'Muestra la página de un museo'),
    url(r'^(.*)/xml/?$', views.xml, name = 'Canal XML'),
    url(r'^rss/?$', views.rss, name = 'Canal RSS para comentarios'),
    url(r'^login/?$', views.loginUser, name = 'Login de los usuarios'),
    url(r'^logout/?$', views.logoutUser, name = 'Logout de los usuarios'),
